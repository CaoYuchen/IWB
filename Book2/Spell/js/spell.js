...
$(function() {
	...
	var front = ['b', 'c', 'd', 'l', 'p', 'r'];
	var middle = ['a', 'e', 'i', 'o', 'u'];
	var end = ['g', 'x', 't', 'n', 'd', 'p'];

	var library = ['pig','leg','bag','big','box','cat','dog','fox','pen','red','run','cap'];
    ...
    var cardfront = new Array(6);
    var cardmiddle = new Array(5);
    var cardend = new Array(6);
    ...
    // console.log(cardend);
    if(cardfront[0][0] == library[0].charAt(0) && cardmiddle[0][0] == library[0].charAt(1) && cardend[0][0] == library[0].charAt(2))
    {
    	arrangeCard();
    }
    ...
    function showSlides(n) {
        ...
        if(correct[slideIndex-1]){
	        ...
	        if(cardfront[slideIndex-1][numberF] == library[slideIndex-1].charAt(0) && cardmiddle[slideIndex-1][numberM] == library[slideIndex-1].charAt(1) && cardend[slideIndex-1][numberE] == library[slideIndex-1].charAt(2))
	        {
	        	numberF = Math.floor(Math.random() * maxNumber);
	        	var numberTemp = numberM;
	        	while(numberM == numberTemp)
	        	{
	        		numberM = Math.floor(Math.random() * maxNumber);
	        	}
	        	numberE = Math.floor(Math.random() * maxNumber);
    ...
    function switchSlides(tag) {
        ...
        if(library[slideIndex-1] == (cardfront[slideIndex-1][numberF] + cardmiddle[slideIndex-1][numberM] + cardend[slideIndex-1][numberE]))
        {
            ...
            setTimeout(function(){
                ...
                setTimeout(function(){
                $('#card1').removeClass('animated','bounceOut');
                $('#card2').removeClass('animated','bounceOut');
                $('#card3').removeClass('animated','bounceOut');                
                },1000);                
            },1200);
