...
$(document).delegate('#plus', 'click', function(event) {
        ...
        new roster({
            ...
            <img src='./media/boy.png' id='boy' class='gender-choose' width='200px' style='padding: 100px 30px 25px 100px' onclick='boyorgirl(\"boy1\")'> \
            <img src='./media/girl.png' id='girl' class='gender-choose' width='200px'  style='padding: 100px 100px 25px 30px' onclick='boyorgirl(\"girl1\")'>\
            ...
            <img class='color-btn' id='colorgirl1' src='./media/color/selected4.svg' width='46px' onclick='choosecolor(\"girl1\")'>\
            <img class='color-btn' id='colorgirl2' src='./media/color/unselected5.svg' width='46px' onclick='choosecolor(\"girl2\")'>\
            <img class='color-btn' id='colorgirl3' src='./media/color/unselected6.svg' width='46px' onclick='choosecolor(\"girl3\")'>\
            \
...
$(function() {
    $('.member').on('click', function(e){
        if(!starflag){
            ...
            yc = e.offsetY - 22;
            classname = $(this).attr("id");
            star = '<img class="scorep ' + classname + '" src="'+ src +'" width="55px" height="55px" style="top:'+yc +'px;left:'+xc+'px">';
            // console.log(classname);
...
$(function(){
    $('.Spin-overlay-menu').click(function () {
        ...
        $('.students').hide();
        $('.groups').hide();
        // $('body').css('background-image','url(./Spinner/media/background.jpg)');
        $('.topbutton').hide();
        if(!starflag)
        {
            $('#currentstar').removeClass('flip animated');
...
$(function(){
    ...
    $('.drag-layer:eq(9)')[0],$('.drag-layer:eq(10)')[0],$('.drag-layer:eq(11)')[0],$('.groupmember:eq(0)')[0],$('.groupmember:eq(1)')[0],
    $('.groupmember:eq(2)')[0],$('.groupmember:eq(3)')[0],$('.groupmember:eq(4)')[0],$('.groupmember:eq(5)')[0],$('.groupmember:eq(6)')[0],
